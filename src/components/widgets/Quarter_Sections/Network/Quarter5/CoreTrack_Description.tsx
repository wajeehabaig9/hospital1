            ...
            <main>
                <div className="flex flex-col-reverse sm:flex-row gap-10">
                    <div className="flex-1">
                        ...
                        <h4 className="text-#00616c font-bold sm:text-lg text-base" data-aos="fade-down" data-aos-offset="200" data-aos-delay="50" data-aos-duration="2000"  data-aos-easing="ease-in-out" data-aos-once="true">NPA-361: Network Programmability and Automation</h4>
              ...
              <p className="text-white text-xl font-bold mt-1.5">13 Weeks</p>
                        ...
                        <div className="mt-3">
                        <Link href={"https://www.amazon.com/Network-Programmability-Automation-Networking-Technology/dp/1587145146/ref=sr_1_3"} className="text-blue-500 hover:text-purple-500 duration-300 underline font-normal sm:text-lg text-sm mt-3" data-aos="fade-down" data-aos-offset="200" data-aos-delay="50" data-aos-duration="2000"  data-aos-easing="ease-in-out" data-aos-once="true">https://www.amazon.com/Network-Programmability-Automation-Networking-Technology/dp/1587145146/ref=sr_1_3</Link>
                        </div>
                        </div>
                        </div>
                    </div>
