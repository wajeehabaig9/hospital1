            ...
            <main>
                <div className="flex flex-col-reverse sm:flex-row gap-10">
                    <div className="flex-1">
                        ...
                        <h4 className="text-#00616c font-bold sm:text-lg text-base" data-aos="fade-down" data-aos-offset="200" data-aos-delay="50" data-aos-duration="2000"  data-aos-easing="ease-in-out" data-aos-once="true">AI-361: Deep Learning and MLOps</h4>
              ...
              <p className="text-white text-xl font-bold mt-1.5">13 Weeks</p>
                        ...
                        <h4 className="text-black font-semibold sm:text-3xl text-xl mt-6" data-aos="fade-down" data-aos-offset="200" data-aos-delay="50" data-aos-duration="2000"  data-aos-easing="ease-in-out" data-aos-once="true">CDK for Terraform</h4>

                        <div className="mt-3">
                        <Link href={"https://developer.hashicorp.com/terraform/cdktf"} className="text-blue-500 hover:text-purple-500 duration-300 underline font-normal sm:text-lg text-sm mt-3" data-aos="fade-down" data-aos-offset="200" data-aos-delay="50" data-aos-duration="2000"  data-aos-easing="ease-in-out" data-aos-once="true">https://developer.hashicorp.com/terraform/cdktf</Link>
                        </div>
                        </div>
                        </div>
                    </div>
