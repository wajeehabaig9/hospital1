...
const Hero_Section = () => {
  ...
  const Heading = "Network Programmability\nand Automation\nSpecialization"
        ...
        <Wrapper>
          <div className="flex flex-col items-center sm:flex-row xl:gap-x-12 z-10">
            ...
            <h4 className="text-base sm:text-xl text-teal-500 font-bold">Specalize Track</h4>
              <h1 className="text-3xl sm:text-text-space font-bold sm:leading-75 text-white whitespace-pre-line">{Heading}</h1>
              <p className="sm:text-lg text-p leading-6 sm:leading-0 text-white font-bold mt-6">More than ever, network engineers are finding it challenging to complete their duties entirely manually. Network automation is now crucial due to new protocols, technologies, delivery models, and the requirement for enterprises to become more adaptable and agile. This course teaches network engineers how to automate systems with code using a variety of technologies and tools, including Linux, Python, APIs, and Git.</p>
            ...
            <div className="flex-1 flex justify-center">
              <Image src={CoreTracks} alt="Image" className="w-full sm:w-9/12"/>
            </div>
