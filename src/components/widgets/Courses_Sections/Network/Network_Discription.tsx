    ...
    <section className="mt-24" >
      <main className="flex flex-col-reverse sm:flex-row gap-10">
        <div className="flex-1">
          ...
          <h4 className="text-15 sm:text-lg text-#00616c font-bold" data-aos="fade-down" data-aos-offset="200" data-aos-delay="50" data-aos-duration="2000"  data-aos-easing="ease-in-out" data-aos-once="true">NPA-351: CCNA 200-301 Certification</h4>
          ...
          <p className="mt-2 text-sm sm:text-lg text-blue-500 hover:text-purple-500 duration-300 font-normal underline" data-aos="fade-down" data-aos-offset="200" data-aos-delay="50" data-aos-duration="2000"  data-aos-easing="ease-in-out" data-aos-once="true"><Link target="_blank" href={"https://www.amazon.com/CCNA-200-301-Official-Guide-Library/dp/1587147149/ref=sr_1_1"}>https://www.amazon.com/CCNA-200-301-Official-Guide-Library/dp/1587147149/ref=sr_1_1</Link></p>
          </div>
...
export default Network_Discription
